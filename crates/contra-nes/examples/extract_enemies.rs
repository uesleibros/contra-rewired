...
fn main() {
    ...
    let ptr_tbl = contra_native::enemy::enemy_spawn::level_enemy_screen_ptr_tbl_prg_offset(&rom.prg_rom, 0);
    ...
    for screen_index in 1..header.screen_count {
        let offset = contra_native::enemy::enemy_spawn::enemy_screen_prg_offset(&rom.prg_rom, ptr_tbl, screen_index);
        let spawns = contra_native::enemy::enemy_spawn::decompress_outdoor_enemy_screen(&rom.prg_rom[offset..]);
    ...
    let screen_9_offset = contra_native::enemy::enemy_spawn::enemy_screen_prg_offset(&rom.prg_rom, ptr_tbl, 9);
    let screen_9 = contra_native::enemy::enemy_spawn::decompress_outdoor_enemy_screen(&rom.prg_rom[screen_9_offset..]);
    let expected = [
        contra_native::enemy::enemy_spawn::EnemySpawn { x: 0x10, y: 0x40, enemy_type: 0x03, attribute: 0b000 },
        contra_native::enemy::enemy_spawn::EnemySpawn { x: 0x10, y: 0xb0, enemy_type: 0x03, attribute: 0b100 },
        contra_native::enemy::enemy_spawn::EnemySpawn { x: 0xe0, y: 0x80, enemy_type: 0x07, attribute: 0b001 },
    ];
